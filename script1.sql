...
select a.* from JSON_TABLE('[
    ...
    '$[*]' COLUMNS(
            ...
            year int PATH '$.year', 
            runtime int PATH '$.runtime', 
            genre1 varchar(255) PATH '$.genres[0]',
            genre2 varchar(255) PATH '$.genres[1]',
            genre3 varchar(255) PATH '$.genres[2]',
            director varchar(255) PATH '$.director', 
            actors varchar(1000) PATH '$.actors', 
            plot varchar(3000) PATH '$.plot',
            image varchar(1000) PATH '$.posterUrl'
        )) a;
